export const perguntas = [
    {
        ...
        alternativas:[
            {
                texto:"Um país em desenvolvimento possui um excedente orçamentário inesperado de $10 bilhões que deve ser integralmente alocado para investimentos de longo prazo. O governo está debatendo se deve priorizar a melhoria imediata do bem-estar social ou o estímulo direto ao crescimento econômico para garantir a estabilidade futura.",
                afirmacao:[
                    "Investir os $10 bilhões no Capital Humano é a decisão mais estratégica, pois garante que a próxima geração seja a mais bem educada e a mais saudável da nossa história.",
            ],
                proxima: 1,
            },
            {
                texto:"Alocar a totalidade dos $10 bilhões para o Fundo de Estímulo Industrial, concedendo isenções fiscais maciças e subsídios diretos a grandes corporações dos setores de tecnologia e exportação, sob a condição de que criem empregos nos próximos 5 anos.",
                afirmacao:[
                    "A riqueza gerada por essa aceleração econômica é o motor que, a médio prazo, fornecerá uma base tributária muito maior para financiar, de forma sustentável e não apenas pontual, todos os futuros programas sociais de educação e saúde.",
                    ],
                proxima: 2,
            }
        ]
...
{
    enunciado:"Com os $10 bilhões destinados à infraestrutura, o debate se concentra em qual tipo de investimento trará o maior benefício composto: aumentar a produtividade econômica imediata (focada em logística e comércio) ou diminuir os custos sociais e ambientais de longo prazo (focada em energia e saneamento).",
    alternativas:[
        {
            texto:"Alocar os $10 bilhões em projetos de Logística e Comércio, incluindo a construção de novas rodovias de alta velocidade ligando portos e centros industriais, e a modernização de ferrovias para o escoamento de commodities.",
            afirmacao:[
                "O investimento de $10 bilhões em Rodovias de Alta Velocidade e Modernização Ferroviária é a forma mais rápida e eficiente de desbloquear o potencial de exportação do país, reduzindo o Custo Brasil que asfixia nossas indústrias e a nossa agricultura.",
       ],
            proxima: 3,
        },
        {
            texto:"Alocar os $10 bilhões em Saneamento Básico Universal (tratamento de água e esgoto em 100% dos municípios) e em Infraestrutura de Energia Limpa (subsidiar a instalação de painéis solares em edifícios públicos e expandir parques eólicos).",
            afirmacao:[
                "O Saneamento Básico, ao eliminar doenças de veiculação hídrica, injeta um ganho imediato de produtividade na força de trabalho, reduz a evasão escolar e diminui drasticamente os gastos do sistema de saúde.",
        ],
            proxima: 4,
        }
    ]
